...
python utils/cifar5m_runs.py python scripts/cifar100.py --distillation_type vanilla --batch_size 128  --checkpoints --notes cifar100-convnet200-distillation --wandb_project DataEfficientDistillation
