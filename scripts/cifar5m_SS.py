...
We train the teacher with self-supervision on other data, then learn a head for the current dataset and apply distillation. 


example commands: 

python scripts/cifar5m_SS.py --seed 11 --alpha 0 --gpus_id 1 --buffer_size 20000 --distillation_type vanilla --batch_size 128  --checkpoints --notes cifar5msmall-distillation --wandb_project DataEfficientDistillation
